...
export default class Auth {
  ...
  async login(callback) {
   ...
   // console.log(postData.password);
    ...
    console.log(data);
      ...
      // let's get the user details as well and store 
      //them locally in the class
      // you can pass a query to the API by appending 
      //it on the end of the url like this: 'users?email=' + email
      ...
      // since we have a token let's go grab some data 
      //from the API by executing the callback if one was passed in
  ...
  // uses the email of the currently 
  //logged in user to pull up the full 
  //user details for that user from the database
...
// //url appends the base url with a key value pair that accesses the database json file.
// //users:[email:value stored in email parameter]
